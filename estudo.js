...
function moeda(atual){
   return atual.atual.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});

}
function total(){
    let v = document.getElementById("meses").value;
    if (!Number(v)){
        alert("O campo valor deve ser número");
    ...
    if (!Number(j)){
        alert("O campo juros deve ser número");
    ...
    if (!Number(t)){
        alert("O campo meses deve ser número");
